...
void test_qcheck_max_test_count_auto_0()
{
...
void test_qcheck_max_test_count_prop_0()
{
    using namespace qchk;
    ...
    property<int, double> const prop2 =
        _1>0 && _1%10 == 9 >>=
            ((_1+_2) == (_2+_1));
    auto config = make_config(_1 = igen, _2 = dgen);
    auto res = qcheck(prop2, config);
...
test_suite* init_unit_test_suite( int argc, char* argv[] )
{
    ...
    test->add(BOOST_TEST_CASE(&test_qcheck_max_test_count_auto_0));
    test->add(BOOST_TEST_CASE(&test_qcheck_max_test_count_prop_0));
